/******************************************************
** Name                 : [AZ_FND_NEST_SF].[STG_FND_PROVISIONAL_ASSET]
** Description          : This staging table holds provisional asset details from SF
** Author               : Pradeep
...
**  2026/05/05      Pradeep         Initial - Added Provisional Asset staging table
 *******************************************************/

CREATE TABLE [AZ_FND_NEST_SF].[STG_FND_PROVISIONAL_ASSET]
(
	...
	[ST_IsVoid__c] VARCHAR(255) NULL,
	[ST_WorkOrderLineItem__c] VARCHAR(255) NULL,
	[ST_WorkOrder__c] VARCHAR(255) NULL,
	[ST_Asset__c] VARCHAR(255) NULL,
	[ST_IsNewAsset__c] VARCHAR(255) NULL,
	[ST_AssetScriptCompleted__c] VARCHAR(255) NULL,
	[ST_RailwayID__c] VARCHAR(255) NULL,
	[ST_AssetGroup__c] VARCHAR(255) NULL,
	[ST_AssetType__c] VARCHAR(255) NULL,
	[ST_AssetStatus__c] VARCHAR(255) NULL,
	[ST_ConstructionDetails__c] VARCHAR(255) NULL,
	[ST_SupportedEquipment__c] VARCHAR(255) NULL,
	[ST_SupportedEquipmentComments__c] VARCHAR(255) NULL,
	[ST_SecondaryEquipment__c] VARCHAR(255) NULL,
	[ST_SecondaryEquipmentComments__c] VARCHAR(255) NULL,
	[ST_AssetHas__c] VARCHAR(255) NULL,
	[ST_PrimaryELR__c] VARCHAR(255) NULL,
	[ST_StartMilage__c] VARCHAR(255) NULL,
	...
	[ST_NoofVerticalElements__c] VARCHAR(255) NULL,
	[ST_NoofHorizontalElements__c] VARCHAR(255) NULL,
	[ST_LengthofHorizontalElementm__c] VARCHAR(255) NULL,
	[ST_PrimaryMaterial__c] VARCHAR(255) NULL,
	[ST_Coating__c] VARCHAR(255) NULL,
	[ST_HeightEstimatem__c] VARCHAR(255) NULL,
	[ST_DimensionAmm__c] VARCHAR(255) NULL,
	[ST_DimensionBmm__c] VARCHAR(255) NULL,
	[ST_AssetName__c] VARCHAR(255) NULL,
	[ST_Centroid__c] VARCHAR(255) NULL,
	[ST_AssetHierarchyStatus__c] VARCHAR(255) NULL,
	[ST_GeneralComments__c] VARCHAR(255) NULL,
